...
const drawerPanel = document.querySelector(".possibilities-drawer");
const clueCombinationsList = document.querySelector(
  "#possibleClueCombinations"
);

togglePossibilities.addEventListener("click", () => {
  drawerPanel.classList.toggle("show");
  drawerPanel.classList.toggle("slide");
});

toggleClueCombinations.addEventListener("click", () => {
  clueCombinationsList.classList.toggle("show");
});
